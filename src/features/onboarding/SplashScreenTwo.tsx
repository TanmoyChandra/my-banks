...
const styles = StyleSheet.create({
  ...
  logoText: { color: '#000000', fontSize: 18, fontWeight: '900', fontFamily: 'SpaceGrotesk', letterSpacing: -0.5 },
  skipBtn: { backgroundColor: '#FFFFFF', paddingHorizontal: 16, paddingVertical: 8, borderRadius: 20 },
  skipText: { color: '#000000', fontSize: 14, fontWeight: '800', fontFamily: 'SpaceGrotesk' },
  ...
  title: { fontSize: 48, fontWeight: '900', fontFamily: 'SpaceGrotesk', letterSpacing: -2, marginBottom: 16, color: '#000000', lineHeight: 52 },
  subtitle: { fontSize: 16, lineHeight: 26, fontWeight: '500', fontFamily: 'SpaceGrotesk', color: '#3F3F46' },
