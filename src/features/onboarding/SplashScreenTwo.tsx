...
const styles = StyleSheet.create({
  container: { flex: 1, backgroundColor: '#AAEF00' },
  header: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingHorizontal: 24, paddingTop: 16 },
  logoText: { color: '#000000', fontSize: 18, fontWeight: '900', fontFamily: 'PlusJakartaSans-ExtraBold', letterSpacing: -0.5 },
  skipBtn: { backgroundColor: '#FFFFFF', paddingHorizontal: 16, paddingVertical: 8, borderRadius: 20 },
  skipText: { color: '#000000', fontSize: 14, fontWeight: '800', fontFamily: 'PlusJakartaSans-ExtraBold' },
  ...
  greenDash1: { width: 30, height: 8, backgroundColor: '#AAEF00', borderRadius: 4, position: 'absolute', bottom: 60, left: 70, transform: [{ rotate: '-10deg' }] },
  greenDash2: { width: 20, height: 8, backgroundColor: '#AAEF00', borderRadius: 4, position: 'absolute', bottom: 55, left: 105, transform: [{ rotate: '-10deg' }] },
  title: { fontSize: 48, fontWeight: '900', fontFamily: 'PlusJakartaSans-ExtraBold', letterSpacing: -2, marginBottom: 16, color: '#000000', lineHeight: 52 },
  subtitle: { fontSize: 16, lineHeight: 26, fontWeight: '500', fontFamily: 'PlusJakartaSans-Medium', color: '#3F3F46' },
